                            ...
                            if dist_cfg.get("encoder_matching", {}).get("enable"):
                                ...
                                if (
                                    ...
                                    try:
                                        ...
                                        enc_loss_val = enc_loss_val + weight * w_enc * enc_loss
                                        if step % 20 == 0:
                            ...
                            if dist_cfg.get("decoder_matching", {}).get("enable"):
                                ...
                                if (
                                    ...
                                    try:
                                        ...
                                        dec_loss_val = dec_loss_val + weight * w_dec * dec_loss
                                        if step % 20 == 0:
                            ...
                            if dist_cfg.get("attention_matching", {}).get("enable"):
                                ...
                                if (
                                    ...
                                    try:
                                        ...
                                        attn_loss_val = attn_loss_val + weight * w_attn * attn_loss
                                        if step % 20 == 0:
                            ...
                            if dist_cfg.get("relational_KD", {}).get("enable"):
                                ...
                                if (
                                    ...
                                    try:
                                        ...
                                        rkd_loss_val = rkd_loss_val + weight * w_rkd * rk_loss
                                        if step % 20 == 0:
